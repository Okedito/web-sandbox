...
- domain:
  ...
  dkim_main_value: cadeaux-pluxee-fr.hs19a.dkim.hubspotemail.net.
  dkim_secondary_type: CNAME
  dkim_secondary_host: hs2-146250427._domainkey.cadeaux
  dkim_secondary_value: cadeaux-pluxee-fr.hs19b.dkim.hubspotemail.net.
  spf_type: TXT
  spf_host: "@"
  spf_value: include:146250427.spf05.hubspotemail.net
  dmarc_type: TXT
