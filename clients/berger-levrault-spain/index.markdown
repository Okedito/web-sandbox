---
title: Berger-Levrault Spain
layout: page
logo: yes
sandbox: no
language: en
hs_region: eu1
hs_portalId: 27220184
brand_domain: berger-levrault.eu
main_domains:
#- name: Website pages	
#  type: CNAME
#  host: website-page
...
- domain:
  ...
  dkim_main_host: hs1-27220184._domainkey.email
  dkim_main_value: email-berger--levrault-com.hs07a.dkim.hubspotemail.net.
  dkim_secondary_type: CNAME
  dkim_secondary_host: hs2-27220184._domainkey.email
  dkim_secondary_value: email-berger--levrault-com.hs07b.dkim.hubspotemail.net.
  spf_type: TXT
  spf_host: "@"
  spf_value: include:27220184.spf01.hubspotemail.net
  dmarc_type: TXT
  dmarc_host: _dmarc
